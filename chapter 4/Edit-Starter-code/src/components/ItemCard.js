...
export const ItemCard = ({image, item, toggleEdit, onChange, index}) => (
            ...
            item.isEditing ?  
              <div className="mb-4">
                ...
                <input 
                  ...
                  //TODO 14: Use an arrow function which accepts an event and  returns the onChange prop as the value to the onChange attribute to both the name and price input elements passing it the event and index.
